...
namespace Plataforma_academica.Models
{
    public class Registrar_Cursos
    {
        ...
        public bool Registrar_curso_(Registrar_Cursos obj)
        {

            conexion = new Conexion.Conexion();
            int x = conexion.Execute_Operation("call Pr_ingresar_curso_ ('" + obj.Nombre_curso + "','" + obj.descripcion_curso + "','" + obj.codigo_tematica + "')");
            return x >= 0 ? true : false;
